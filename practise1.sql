...
(                                                                                             
id serial primary key  ,  --serial otomatik id ekliyo                                                                    
isim varchar(20),                                                                             
yas int,                                                                                      
maas int,                                                                                     
email varchar(30)                                                                             
...
select * from personel where maas<>21000;--is not

-- 7) ismi a harfi ile başlayan personel bilgilerini listeleyiniz.
select * from personel where isim ilike 'A%';--% isareti ne devam ederse etsin demek
...
select * from personel where id in(3,5,7,9);select * from personel where id= 3 or id=5 or id=7 or id=9;
...
select * from personel order by  yas ;--dogal siralamasi kucukten buyuge
...
select * from personel order by yas desc;--tersten sirali
