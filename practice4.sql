...
--in kullanacaksaniz parantez icine aldiginiz sorgu birden fazal deger donmeli 

select * from calisanlar;--tablo iciin birlesme yeri isyeri sutunu 
select * from markalar;--burasi da marka_isim sutunu 
