--EXISTS,NOT EXISTS--
--EXISTS condition subguery` ler ile kullanilir.IN ifadesinin kullanimina benzer 
--EXISTS not exists ifadeleri de alt sorgudan getirilen degerlerin icinde
--bir degerin olmasi veya olmamasi durumunda islem yapilmasini saglar 
--exisit true,false gibidir .Bollean
CREATE TABLE mart
(
	urun_id int,
