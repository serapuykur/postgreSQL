...
--SORU1: Iki Tabloda sirket_id’si ayni olanlarin; sirket_ismi, siparis_id  sirket idve
...
select A.sirket_id, A.sirket_isim,B.siparis_id,B.siparis_tarihi from sparisler as B
